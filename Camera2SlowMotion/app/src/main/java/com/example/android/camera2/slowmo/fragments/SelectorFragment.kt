...
import com.example.android.camera.common.GenericListAdapter
import com.example.android.camera2.slowmo.R

/**
 * In this [Fragment] we let users pick a camera, size and FPS to use for high speed video recording
 */
